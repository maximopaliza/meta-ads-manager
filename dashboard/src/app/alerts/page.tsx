      ...
      <div style={{ marginLeft: '220px', flex: 1 }}>
        ...
        <main style={{ padding: '32px', maxWidth: '1400px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {(alerts || []).length === 0 ? (
              <div style={{ backgroundColor: '#071428', border: '1px solid #1A4080', borderRadius: '12px', padding: '48px', textAlign: 'center', color: '#7A90AA' }}>
              ...
              (alerts || []).map((alert: Record<string, any>) => (
                <div
                  ...
                  style={{
                    padding: '16px 20px',
                    borderRadius: '12px',
                    border: `1px solid ${severityBorder[alert.severity] || '#1A4080'}`,
                    backgroundColor: severityBg[alert.severity] || '#07142810',
                  }}
                >
