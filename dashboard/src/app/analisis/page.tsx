        ...
        <main style={{ padding: '20px 16px', maxWidth: '100%' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap' as const, gap: '8px' }}>
            <div style={{ display: 'flex', gap: '4px' }}>
              {(['summary', 'table'] as const).map(v => (
                <a key={v} href={`?view=${v}&days=${days}`} style={{ padding: '6px 16px', borderRadius: '6px', fontSize: '12px', fontWeight: 500, textDecoration: 'none', backgroundColor: view === v ? '#6366F1' : 'transparent', color: view === v ? '#fff' : C_MUTED, border: `1px solid ${view === v ? '#6366F1' : '#1A4080'}` }}>
          ...
          {view === 'summary' ? (
            <>
              ...
              ══════════════════════════════════════════ */}
              {dailyRows.length > 1 && (
                <div style={{ marginBottom: '20px', backgroundColor: '#071428', border: '1px solid #1A4080', borderRadius: '12px', padding: '16px 16px 14px' }}>
              ...
              ══════════════════════════════════════════ */}
              {last5Asc.length > 0 && (
                <div style={{ marginBottom: '20px', backgroundColor: '#071428', border: '1px solid #1A4080', borderRadius: '12px', overflow: 'hidden', borderTop: '2px solid #6366F1' }}>
                  <div style={{ padding: '10px 16px', borderBottom: '1px solid #1A4080', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              {/* ══════════════════════════════════════════
                  5. SEMANA VS SEMANA
              ══════════════════════════════════════════ */}
              <div style={{ marginBottom: '20px', backgroundColor: '#071428', border: '1px solid #1A4080', borderRadius: '12px', overflow: 'hidden' }}>
                <div style={{ padding: '10px 16px', borderBottom: '1px solid #1A4080' }}>
                ...
                <div style={{ padding: '16px', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px, 1fr))', gap: '10px' }}>
                  {wkItems.map(item => {
                    ...
                    return (
                      <div key={item.label} style={{ backgroundColor: '#030810', borderRadius: '8px', padding: '12px', border: '1px solid #1A4080' }}>
              ...
              {dayAnalyses.length > 0 && (
                <div style={{ marginBottom: '20px' }}>
                  ...
                  {dayAnalyses.map((a: any) => (
                    <div key={a.id} style={{ backgroundColor: '#071428', border: '1px solid #6366F130', borderRadius: '12px', padding: '18px 20px', marginBottom: '10px' }}>
                ...
                <div style={{ backgroundColor: '#071428', border: '1px solid #1A4080', borderRadius: '12px', overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column' as const, gap: '8px' }}>
                    {recentAlerts.slice(0, 5).map((a: any) => (
                      <div key={a.id} style={{ padding: '10px 12px', backgroundColor: '#030810', borderRadius: '8px', border: `1px solid ${a.severity === 'critical' ? '#EF444440' : a.severity === 'warning' ? '#F59E0B40' : '#6366F140'}` }}>
                    ...
                    {dailyRows.map((d: any) => {
                      ...
                      return (
                        <tr key={d.date} style={{ backgroundColor: isToday ? '#6366F108' : 'transparent' }}>
                          <td style={{ ...td, textAlign: 'left' as const, color: C_TEXT, fontWeight: isToday ? 700 : 400, position: 'sticky' as const, left: 0, backgroundColor: isToday ? '#1e2030' : '#071428' }}>
